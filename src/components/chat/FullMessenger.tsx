        ...
        <div className="p-4 border-b border-slate-200 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-[#FFF0F4] hover:bg-[#ffe2e9] text-[#FF3D71] text-xs font-bold transition-colors cursor-pointer"
            >
      ...
      {showRightPanel && activeConversation && (
        <div className="w-72 border-l border-slate-200 bg-white hidden xl:flex flex-col p-4 space-y-4 overflow-y-auto">
          ...
          <div className="mt-auto pt-4 border-t border-slate-200 text-[11px] text-slate-500 space-y-1">
            ...
            <p className="font-normal text-slate-400">Direct messages on Sphere are simulated in real-time with instant response capabilities.</p>
          </div>
        </div>
      )}
