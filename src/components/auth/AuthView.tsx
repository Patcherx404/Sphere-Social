...
export const AuthView: React.FC = () => {
  const { registerUser, loginUser, loginWithGoogle, users, loginWithUserId } = useSocial();
        ...
        <div className="p-6 sm:p-8 text-center pb-3">
          ...
          <div className="mt-5">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white hover:bg-slate-50 border border-slate-300 rounded-xl text-xs font-bold text-slate-700 shadow-xs hover:shadow-sm transition-all cursor-pointer group"
            >
              ...
              <span>Continue with Google (projectile.afk@gmail.com)</span>
            </button>
            ...
            <div className="flex items-center justify-between mt-2 text-[11px]">
              <button
                ...
                className="text-[#3366FF] hover:underline font-semibold"
              >
